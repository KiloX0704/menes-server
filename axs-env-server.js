  ...
  try {
    ...
    if (method === 'POST' && pathname === '/api/menes/ensure') {
      ...
      const defaults = {
        ...
        AXS_SUBSPATIAL_CREATE_URL: 'http://101.33.204.121:5555/generate_sub_tasks',
        AXS_SPATIAL_ROUTE_URL: 'http://101.33.204.121:5555/solve_task_route',
        AXS_IMAGE_SEARCH_URL: 'http://113.118.46.22:5555/image_search_navi',
        AXS_LANDMARK_NAVI_URL: 'http://113.118.46.22:5555/landmark_navi',
